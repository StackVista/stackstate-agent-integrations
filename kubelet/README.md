...
The Kubelet check is included in the StackState Agent package, so you don't need to install anything else on your servers.
...
the following lines to your [node-config file][1]:
...
[1]: https://docs.openshift.org/3.7/install_config/master_node_configuration.html#node-configuration-files
