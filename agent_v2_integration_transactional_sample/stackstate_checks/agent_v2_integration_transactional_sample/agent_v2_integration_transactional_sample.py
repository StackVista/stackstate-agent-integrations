...
class AgentV2IntegrationTransactionalSampleCheck(AgentCheckV2):
    ...
    def check(self, instance):
        ...
        self.count("check_runs", state['run_count'], tags=["integration:agent_v2_integration_transactional_sample"])
