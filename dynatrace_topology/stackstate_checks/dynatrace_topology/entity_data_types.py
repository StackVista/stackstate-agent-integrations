...
class LogFileStatus(ForgivingBaseModel):
    logFileStatus: List[LogFileStatusEntry] = []
...
class LogSourceState(ForgivingBaseModel):
    logSourceState: List[LogSourceStateEntry] = []
...
class HostProperties(ForgivingBaseModel):
    additionalSystemInfo: List[Dict[str, Any]] = []
    ...
    customHostMetadata: Dict[str, Any] = {}
    customizedName: Optional[str] = None
    detectedName: Optional[str] = None
    dnsNames: List[str] = []
    dt_security_context: List[str] = []
    ...
    softwareTechnologies: List[SoftwareTechnology] = []
...
class ProcessGroupInstanceProperties(ForgivingBaseModel):
    ...
    boshName: Optional[str] = None
    conditionalName: Optional[str] = None
    customPgMetadata: Dict[str, Any] = {}
    customizedName: Optional[str] = None
    detectedName: Optional[str] = None
    dt_security_context: List[str] = []
    ebpfHasPublicTraffic: Optional[bool] = False
    gardenApplicationNames: List[str] = []
    gcpZone: Optional[str] = None
    hasPublicTraffic: Optional[bool] = False
    installerVersion: Optional[str] = None
    ...
    releasesVersion: Dict[str, Any] = {}
    softwareTechnologies: List[SoftwareTechnology] = []
    versionedModules: List[Dict[str, Any]] = []
...
class ServiceProperties(ForgivingBaseModel):
    ...
    applicationBuildVersion: List[str] = []
    applicationEnvironment: List[str] = []
    applicationName: List[str] = []
    applicationReleaseVersion: List[str] = []
    awsNameTag: Optional[str] = None
    boshName: Optional[str] = None
    ...
    serviceDetectionAttributes: Dict[str, Any] = {}
    serviceTechnologyTypes: List[str] = []
    serviceType: Optional[str] = None
    softwareTechnologies: List[SoftwareTechnology] = []
    unifiedServiceIndicators: List[str] = []
...
class ApplicationEntity(ForgivingBaseModel):
    ...
    fromRelationships: Dict[str, List[Relationship]] = {}
    toRelationships: Dict[str, List[Relationship]] = {}
