...
# project
from stackstate_checks.agent_v2_integration_sample import AgentV2IntegrationSampleCheck
...
class TestAgentIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        config = {}
        self.check = AgentV2IntegrationSampleCheck(self.CHECK_NAME, config, instances=[self.instance])
    ...
    def test_check(self):
        ...
        aggregator.assert_metric('check_runs', count=1, tags=["integration:agent_v2_integration_sample"])
    ...
    def test_topology_items_from_config_check(self):
        ...
        self.check = AgentV2IntegrationSampleCheck(self.CHECK_NAME, {}, instances=[instance_config])
        result = self.check.run()
        assert result == ''
        topo_instances = topology.get_snapshot(self.check.check_id)
