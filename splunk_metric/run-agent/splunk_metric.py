...
class SplunkMetric(SplunkTelemetryBase):
    ...
    def _apply(self, metric, value, **kwargs):
        ...
        self.log.info("metric: {}".format(metric))
        self.log.info("value: {}".format(float(value)))
        self.log.info("tags: {}".format(tags))
        self.log.info("hostname: {}".format(hostname))
        self.log.info("device_name: {}".format(device_name))
        self.log.info("timestamp: {}".format(int(timestamp)))
