class TestHelloWorldSplunkMetrics:
    def test_introduction(self, aggregator):
        assert 1 == 1

# TODO: Code below does not execute and looks like a direct copy
# TODO: Commenting it out for now and using it as reference
...
#         self.assertEqual(len(self.metrics), 1)
#
#         # Restart check and recover data considering max restart history seconds
#         test_data["time"] = time_to_seconds('2017-03-08T12:00:00.000000+0000')
#         test_data["earliest_time"] = '2017-03-08T11:00:00.000000+0000'
#         self.run_check(config, mocks=test_mocks, force_reload=True)
#         self.assertEqual(len(self.metrics), 2)
...
#         """
#             Splunk metric check should fail and raise exception when audience param is not set
#         """
#
#         config = {
#             'init_config': {},
...
#         """
#             Splunk metric check should fail and raise exception when name param is not set
#         """
#
#         config = {
#             'init_config': {},
...
#         """
#             Splunk metric check should prefer Token based authentication over Basic auth mechanism
#         """
#
#         config = {
#             'init_config': {},
...
#         """
#             Splunk metric check should fail when memory token is expired itself.
#         """
#
#         config = {
#             'init_config': {},
