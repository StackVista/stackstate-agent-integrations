...
class HTTPHelper:
    ...
    #   http_method_enums = [item.value for item in HTTPMethodEnum]
...
#
    ...
    #     elif http_method in self.http_method_enums:
...
#
    ...
    #         if method_type_index > -1 and self.http_method_enums[method_type_index]:
    #             self.request_object.method = self.http_method_enums[method_type_index]['type']
#
