...
def test_use_proxy():
    with mock.patch('stackstate_checks.checks.AgentCheck._get_requests_proxy', return_value=PROXY_SETTINGS):
        check = AgentCheck()
...
def test_http_proxy_fail():
    ...
    try:
        with mock.patch('stackstate_checks.checks.AgentCheck._get_requests_proxy', return_value={}):
            check = AgentCheck()
