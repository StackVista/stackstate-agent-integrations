...
def construct_template_fields(integration_name, **kwargs):
    ...
    email_packages = 'info@stackstate.com'
    install_info = (
        'The {check_name_cap} check is included in the [StackState Agent][2] package, so you do not\n'
