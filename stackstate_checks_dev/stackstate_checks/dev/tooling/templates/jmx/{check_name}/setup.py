...
# Get version info
ABOUT = {{}}
with open(path.join(HERE, 'stackstate_checks', '{check_name}', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='stackstate-{check_name}',
    version=ABOUT['__version__'],
    description='The {check_name_cap} check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='stackstate agent {check_name} check',
    ...
    packages=['stackstate_checks.{check_name}'],
