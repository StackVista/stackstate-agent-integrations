...
def test_get_agent_tags():
    with mock.patch('stackstate_checks.dev.tooling.git.git_tag_list') as tag_lst:
        from stackstate_checks.dev.tooling.commands.agent.common import get_agent_tags
